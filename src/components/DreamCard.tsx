...
const DreamCard: React.FC<DreamCardProps> = ({ dream }) => {
  ...
  return (
    <div onClick={()=>{router.push(`/${dream._id}`)}} className="flex flex-col w-[30rem] mr-3 bg-transparent rounded-2xl p-5 gap-4 border-[0.2rem] border-purple-700 shadow-md hover:shadow-2xl shadow-purple-400 hover:shadow-neonPink  hover:scale-105 duration-500 cursor-pointer">
